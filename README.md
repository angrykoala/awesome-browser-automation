...
* [agent-qa](https://github.com/vostride/agent-qa) - Self-improving agentic QA harness that writes natural-language web tests and heals browser interactions using execution memory.
