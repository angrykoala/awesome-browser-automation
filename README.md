...
* [Safari MCP](https://github.com/achiya-automation/safari-mcp) - Native Safari browser automation for AI agents via AppleScript. 80 tools, zero Chrome overhead, keeps logins.
