...
* [PhantomJS](https://github.com/ariya/phantomjs) - Headless browser for Node.js. (Deprecated - use Playwright or Puppeteer instead)
* [Playwright](https://github.com/microsoft/playwright) - Cross-browser web automation platform for Node.js. (Supports Firefox, Chrome, and WebKit)
...
* [Spectron](https://github.com/electron-userland/spectron) - Test Electron apps using WebDriver.
