...
* [Playwright](https://github.com/microsoft/playwright) - Cross-browser web automation platform for Node.js.
  * [Playwright-Praman](https://github.com/nichestack/playwright-praman) - Playwright plugin for SAP UI5, Fiori and S/4HANA test automation with AI-powered test generation and 199 typed control proxies.
